...
export default function Publish({ setPublish }){
    return(
        <div className='flex flex-col items-center justify-between p-8 rounded z-10 shadow-xl bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vh]'>
